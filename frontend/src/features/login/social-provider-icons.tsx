import { FederationProviderIcon } from './federation-provider-icons'
...
export interface FederationLoginProvider {
  provider: string
  name: string
  href: string
}
...
interface SocialLoginGridProps {
  providers: FederationLoginProvider[]
}

export function SocialLoginGrid({ providers }: SocialLoginGridProps) {
