...
func NotFoundError(resource string, cause error) *AppError {
	...
	return WrapError(cause, constants.NotFound, msg, ErrorTypeNotFound, http.StatusNotFound)
}
...
// CodedUnauthorized creates an unauthorized error with a specific i18n code.
func CodedUnauthorized(code string, cause error) *AppError {
	return WrapError(cause, code, "", ErrorTypeUnauthorized, http.StatusUnauthorized)
}

// CodedValidation creates a validation error with a specific i18n code.
func CodedValidation(code string, cause error) *AppError {
	return WrapError(cause, code, "", ErrorTypeValidation, http.StatusBadRequest)
}

// CodedConflict creates a conflict error with a specific i18n code.
func CodedConflict(code string, cause error) *AppError {
	return WrapError(cause, code, "", ErrorTypeConflict, http.StatusConflict)
}
...
func GetAppError(err error) *AppError {
	appErr, _ := errors.AsType[*AppError](err)
	return appErr
}
