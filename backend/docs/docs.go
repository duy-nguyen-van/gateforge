...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dtos.OpenIDConfigurationResponse"
                        }
                    }
                }
            }
        ...
        "/admin/audit-logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by action (exact or prefix with trailing dot)",
                        "name": "action",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminAuditLogResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminClientResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AdminCreateClientRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.AdminCreateClientResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
        ...
        "/admin/clients/{clientId}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Client record UUID",
                        "name": "clientId",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AdminUpdateClientRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.AdminClientUsageResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
        ...
        "/admin/tenants": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminTenantResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Tenant name and optional domain",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AdminCreateTenantRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AdminUpdateTenantRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/tenants/{tenantId}/identity-providers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminIdentityProviderResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
        ...
        "/admin/tenants/{tenantId}/identity-providers/{provider}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Provider id (e.g. google)",
                        "name": "provider",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "OAuth credentials and enabled flag",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminTenantMemberResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.AdminAddMemberRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.AdminUserResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.AdminUserDetailResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
        ...
        "/authorize": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Session cookie from browser login (iam_session)",
                        "name": "Cookie",
                        "in": "header"
                    },
                    {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to client or login",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/federation/providers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tenant UUID (defaults to DEFAULT_TENANT_ID)",
                        "name": "tenant_id",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.PublicFederationProviderResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
        ...
        "/internal/tenants/{tenantId}/identity-providers/{provider}": {
            "patch": {
                "tags": [
                    "internal"
                ],
        ...
        "/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "When MFA is off: LoginResponse. When MFA is on: same envelope but ` + "`" + `data` + "`" + ` is MFALoginChallengeResponse (see top-level description).",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
        ...
        "/login/session": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "When tenant is resolved. When multiple tenants apply, ` + "`" + `data` + "`" + ` is TenantSelectionResponse.",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.TenantSummary"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
        ...
        "/mfa/challenge/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ticket and code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.MFAChallengeVerifyRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.MFARecoveryCodesResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.MFATOTPSetupResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.MFATOTPVerifyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/oidc/federation/{provider}/callback": {
            "get": {
                "tags": [
                    "OIDC"
                ],
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to stored return_to",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/oidc/federation/{provider}/start": {
            "get": {
                "tags": [
                    "OIDC"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "URL to return to after login (must be /authorize on this app)",
                        "name": "return_to",
                        "in": "query",
                        "required": true
                    }
        ...
        "/oidc/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Credentials + return_to",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to return_to with session cookie set",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/tenants/select": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Selection token and tenant",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.TenantSelectRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.TenantSwitchRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domains.OIDCTokenResponse"
                        }
                    }
                }
            }
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/dtos.WebauthnCredentialResponse"
                                    }
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.WebauthnLoginFinishRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "When MFA is off: LoginResponse + iam_session. When MFA is on: ` + "`" + `data` + "`" + ` is MFALoginChallengeResponse (see description).",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.WebauthnLoginStartRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.WebauthnLoginStartResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.WebauthnRegisterFinishRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/dtos.WebauthnRegisterStartRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/dtos.WebauthnRegisterStartResponse"
                                },
                                "meta": {
                                    "$ref": "#/definitions/dtos.Meta"
                                }
    ...
    "definitions": {
        ...
        "dtos.AdminClientUsageResponse": {
            "type": "object",
            "properties": {
                "active_refresh_tokens": {
                    "type": "integer"
                },
                "authorize_events_30d": {
                    "type": "integer"
                },
                "client_id": {
                    "type": "string"
        ...
        "dtos.AdminCreateClientResponse": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "dtos.AdminIdentityProviderResponse": {
            "type": "object",
            "properties": {
                "configured": {
                    "type": "boolean"
        ...
        "dtos.AdminUserDetailResponse": {
            ...
            "properties": {
                ...
                "memberships": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.AdminUserMembershipResponse"
                    }
                },
                "mfa_enabled": {
                    "type": "boolean"
        ...
        "dtos.AdminUserMembershipResponse": {
            "type": "object",
            "properties": {
                "role": {
                    "type": "string"
        ...
        "dtos.HealthResponse": {
            ...
            "properties": {
                "service": {
                    "type": "string",
                    "example": "github.com/gateforge-iam/gateforge-iam"
                },
                "status": {
                    "type": "string",
                    "example": "healthy"
        ...
        "dtos.LoginRequest": {
            ...
            "properties": {
                ...
                "remember_me": {
                    "description": "RememberMe extends the iam_session cookie lifetime (SSO_SESSION_REMEMBER_TTL). API login and POST /oidc/login both honor this.",
                    "type": "boolean"
                },
                "return_to": {
                    "description": "ReturnTo when set (OIDC browser flow): creates a session cookie and redirects here with 302 — no access_token in the response body.",
                    "type": "string"
                },
                "tenant_id": {
                    "description": "TenantID optional explicit tenant context.",
                    "type": "string"
                }
            }
        },
        ...
        "dtos.MFAChallengeVerifyRequest": {
            "type": "object",
            "required": [
                "code",
                "mfa_ticket"
        ...
        "dtos.OpenIDConfigurationResponse": {
            "type": "object",
            "properties": {
        ...
        "dtos.PatchIdentityProviderRequest": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean"
        ...
        "dtos.PublicFederationProviderResponse": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "dtos.WebauthnCredentialResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "dtos.WebauthnLoginFinishRequest": {
            "type": "object",
            "required": [
                "email",
                "session_token"
            ...
            "properties": {
                "credential": {
                    "description": "Credential is the browser PublicKeyCredential JSON from navigator.credentials.get().",
                    "type": "object"
                },
                "email": {
                    "type": "string",
                ...
                "session_token": {
                    "type": "string",
                    "example": "9b2c4e8a-1d3f-4a5b-8c7e-0f1a2b3c4d5e"
                },
                "tenant_id": {
                    "type": "string",
                    "example": "00000000-0000-0000-0000-000000000001"
        ...
        "dtos.WebauthnLoginStartRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "dtos.WebauthnLoginStartResponse": {
            "type": "object",
            "properties": {
                "options": {
                    "type": "object"
        ...
        "dtos.WebauthnRegisterFinishRequest": {
            "type": "object",
            "required": [
                "session_token"
            ],
            "properties": {
                "credential": {
                    "description": "Credential is the browser PublicKeyCredential JSON from navigator.credentials.create().",
                    "type": "object"
                },
                "session_token": {
                    "type": "string",
        ...
        "dtos.WebauthnRegisterStartRequest": {
            "type": "object",
            "properties": {
                "device_name": {
                    "description": "DeviceName optional label stored with the passkey (e.g. \"Work MacBook\").",
                    "type": "string",
                    "maxLength": 255,
                    "example": "Personal iPhone"
                }
            }
        },
        "dtos.WebauthnRegisterStartResponse": {
            "type": "object",
            "properties": {
                "options": {
                    "type": "object"
